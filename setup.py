...
URL = "https://github.com/tped/ovos-skill-poetry"
SKILL_CLAZZ = "PoetrySkill"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-poetry"  # pip install PYPI_NAME
